...
var ReactMde = /** @class */ (function (_super) {
    ...
    function ReactMde(props) {
        ...
        _this.adjustEditorSize = function () {
            var autoGrow = _this.props.autoGrow;
            if (!autoGrow || !_this.textAreaRef) {
                return;
            }
            if (_this.textAreaRef.scrollHeight > _this.textAreaRef.offsetHeight) {
                _this.setState({
                    editorHeight: _this.textAreaRef.scrollHeight + _this.textAreaLineHeight
                });
            }
        };
        _this.setTextAreaRef = function (element) {
            ...
            if (autoGrow && element) {
                ...
                var lineHeight = parseInt(computed.getPropertyValue("line-height"), 10);
                if (isNaN(lineHeight)) {
                    lineHeight = parseInt(computed.getPropertyValue("font-size"), 10) * 1.5;
                }
                _this.textAreaLineHeight = lineHeight;
            }
            _this.adjustEditorSize();
        };
    ...
    ReactMde.prototype.render = function () {
        ...
        return (React.createElement("div", { className: ClassNames_1.classNames("react-mde", "react-mde-tabbed-layout", (_a = classes) === null || _a === void 0 ? void 0 : _a.reactMde, 
             ...
             */
            className) },
            React.createElement(_1.Toolbar, { classes: (_b = classes) === null || _b === void 0 ? void 0 : _b.toolbar, getIcon: getIcon, commands: commands, onCommand: this.handleCommand, onTabChange: this.handleTabChange, tab: selectedTab, readOnly: readOnly, disablePreview: disablePreview, l18n: l18n }),
            React.createElement("div", { className: ClassNames_1.classNames({ invisible: selectedTab !== "write" }) },
                React.createElement(_1.TextArea, { classes: (_c = classes) === null || _c === void 0 ? void 0 : _c.textArea, suggestionsDropdownClasses: (_d = classes) === null || _d === void 0 ? void 0 : _d.suggestionsDropdown, editorRef: this.setTextAreaRef, onChange: this.handleTextChange, readOnly: readOnly, textAreaProps: __assign(__assign({}, textAreaProps), { onKeyDown: function (e) {
                            _this.adjustEditorSize();
                            textAreaProps.onKeyDown && textAreaProps.onKeyDown(e);
                        } }), height: this.state.editorHeight, value: value, suggestionTriggerCharacters: suggestionTriggerCharacters, loadSuggestions: loadSuggestions }),
